        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemberGiftEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    NonMemberMinAmount = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GiftPromotions", x => x.PromotionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeyIngredients = table.Column<string>(type: "text", nullable: true),
                    SkinType = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ...
                    IsMiniGift = table.Column<bool>(type: "boolean", nullable: false),
                    ImageUrl1 = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    AvailableShades = table.Column<string>(type: "text", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkinConcerns = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    BudgetRange = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkinQuizResults", x => x.QuizId);
                    table.ForeignKey(
                        name: "FK_SkinQuizResults_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalTotal = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                    ...
                    FreeGiftProductId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Products_FreeGiftProductId",
                        column: x => x.FreeGiftProductId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedShade = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_FreeGiftProductId",
                table: "Orders",
                column: "FreeGiftProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkinQuizResults_UserId",
                table: "SkinQuizResults",
                column: "UserId");
